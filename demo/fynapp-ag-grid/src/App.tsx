...
// @ts-ignore - esm wrapper
import type { ColDef, GridReadyEvent, GridApi, ValueFormatterParams, RowSelectionOptions, SelectionColumnDef } from 'esm-ag-grid';
// @ts-ignore - esm wrapper
...
const App: React.FC<AppProps> = ({ appName }) => {
  ...
  // Multi-row selection. Checkboxes, header checkbox and click-to-select-off are
  // all defaults of this API, so only the mode needs stating.
  const rowSelection = useMemo<RowSelectionOptions>(() => ({
    mode: 'multiRow',
  }), []);

  // The selection column is generated by the grid; this restores the look of the
  // hand-rolled checkbox column it replaced.
