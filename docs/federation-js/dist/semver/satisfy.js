...
import { parseHyphen, parseComparatorTrim, parseTildeTrim, parseCaretTrim, parseCarets, parseTildes, parseXRanges, parseStar, parseGTE0 } from './parser';
...
export function satisfy(version, range) {
    if (!version) {
        return false;
    }
