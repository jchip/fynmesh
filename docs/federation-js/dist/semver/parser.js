...
import { caret, caretTrim, comparatorTrim, gte0, hyphenRange, star, tilde, tildeTrim, xRange } from './constants';
export function parseHyphen(range) {
...
export function parseComparatorTrim(range) {
    return range.replace(parseRegex(comparatorTrim), '$1$2$3');
}
export function parseTildeTrim(range) {
    return range.replace(parseRegex(tildeTrim), '$1~');
}
export function parseCaretTrim(range) {
    return range.replace(parseRegex(caretTrim), '$1^');
}
export function parseCarets(range) {
    return range
        .trim()
        .split(/\s+/)
        .map((rangeVersion) => {
...
export function parseTildes(range) {
    return range
        .trim()
        .split(/\s+/)
        .map((rangeVersion) => {
...
export function parseXRanges(range) {
    return range
        .split(/\s+/)
        .map((rangeVersion) => {
        return rangeVersion
...
export function parseStar(range) {
    return range.trim().replace(parseRegex(star), '');
}
export function parseGTE0(comparatorString) {
