(function () {
  ...
  class ObservableState {
    constructor(initial) {
      ...
      __privateAdd$4(this, _observers, /* @__PURE__ */ new Set());
      __privateAdd$4(this, _disposed, false);
      this.value = initial;
    }
    /** Get current value */
    get() {
      if (__privateGet$4(this, _disposed)) {
    ...
    set(value) {
      if (__privateGet$4(this, _disposed)) return;
      const prev = this.value;
      this.value = value;
      __privateGet$4(this, _observers).forEach((fn) => {
        try {
          fn(value, prev);
        } catch (e) {
    ...
    subscribe(fn) {
      ...
      __privateGet$4(this, _observers).add(fn);
      return () => __privateGet$4(this, _observers).delete(fn);
    }
    /** Dispose state and clear all observers */
    dispose() {
      __privateSet$2(this, _disposed, true);
      __privateGet$4(this, _observers).clear();
    }
  }
  ...
  const _MiddlewareStateRegistry = class _MiddlewareStateRegistry {
    constructor(parent) {
      __privateAdd$3(this, _parent);
      __privateAdd$3(this, _states, /* @__PURE__ */ new Map());
      __privateAdd$3(this, _pendingWaiters, /* @__PURE__ */ new Map());
      __privateSet$1(this, _parent, parent);
    }
    /**
     ...
     */
    provide(key, initial) {
      if (__privateGet$3(this, _states).has(key)) {
        return __privateGet$3(this, _states).get(key);
      }
      const state = new ObservableState(initial);
      __privateGet$3(this, _states).set(key, state);
      const waiters = __privateGet$3(this, _pendingWaiters).get(key);
      if (waiters) {
        waiters.forEach(({ resolve }) => resolve(state));
        __privateGet$3(this, _pendingWaiters).delete(key);
      }
      return state;
    }
    /**
    ...
    lookup(key) {
      ...
      return __privateGet$3(this, _parent)?.lookup(key);
    }
    /**
     * Check if state exists in this scope or parent scopes.
     */
    has(key) {
      if (__privateGet$3(this, _states).has(key)) return true;
      return __privateGet$3(this, _parent)?.has(key) ?? false;
    }
    /**
    ...
    waitFor(key, timeout = 3e4) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const timer = setTimeout(() => {
          const waiters2 = __privateGet$3(this, _pendingWaiters).get(key);
          const idx = waiters2?.indexOf(waiter) ?? -1;
          if (idx >= 0) {
            waiters2.splice(idx, 1);
            if (waiters2.length === 0) __privateGet$3(this, _pendingWaiters).delete(key);
          }
        ...
        if (waiters) {
          ...
          __privateGet$3(this, _pendingWaiters).set(key, [waiter]);
        }
      });
    }
    /**
     ...
     */
    remove(key) {
      const state = __privateGet$3(this, _states).get(key);
      if (state) {
        state.dispose();
        __privateGet$3(this, _states).delete(key);
        return true;
      }
      return false;
    }
     ...
     */
    clear() {
      __privateGet$3(this, _states).forEach((state) => state.dispose());
      __privateGet$3(this, _states).clear();
      __privateGet$3(this, _pendingWaiters).forEach((waiters, key) => {
        waiters.forEach(({ reject }) => reject(new Error(`Registry cleared while waiting for: ${key}`)));
      });
      __privateGet$3(this, _pendingWaiters).clear();
    }
    /**
     ...
     */
    keys() {
      return Array.from(__privateGet$3(this, _states).keys());
    }
    /**
     * Get parent registry if exists.
     */
    getParent() {
      return __privateGet$3(this, _parent);
    }
  };
  _parent = new WeakMap();
  _states = new WeakMap();
...
Caused by: ${this.cause.message}`;
  ...
  class KernelTelemetryImpl {
    ...
    capture(entry) {
      ...
      if (__privateGet$2(this, _buffer).length >= this.maxBufferSize) {
        __privateGet$2(this, _buffer).shift();
      }
      __privateGet$2(this, _buffer).push(full);
    }
    ...
    get bufferSize() {
      return __privateGet$2(this, _buffer).length;
    }
    flush() {
      if (__privateGet$2(this, _buffer).length === 0) return;
      const batch = __privateGet$2(this, _buffer).splice(0);
  ...
  class FynMeshKernelCore {
    constructor(telemetryConfig) {
      __privateAdd$1(this, _FynMeshKernelCore_instances);
      ...
      __privateAdd$1(this, _globalMiddlewareRegistry, new MiddlewareStateRegistry());
      __privateAdd$1(this, _regionRegistries, /* @__PURE__ */ new Map());
      // Telemetry
    ...
    getMiddlewareRegistry(scope) {
      if (scope === "global") {
        return __privateGet$1(this, _globalMiddlewareRegistry);
      }
      const regionId = scope.region;
      if (!__privateGet$1(this, _regionRegistries).has(regionId)) {
        __privateGet$1(this, _regionRegistries).set(
          regionId,
          __privateGet$1(this, _globalMiddlewareRegistry).createScope()
        );
      }
      return __privateGet$1(this, _regionRegistries).get(regionId);
    }
    /**
    ...
    async prepareMainExport(fynApp) {
      ...
      const middlewareErrors = await this.middlewareExecutor.applyAutoScopeMiddlewares(
        ...
        fynUnit,
        this,
        __privateMethod$1(this, _FynMeshKernelCore_instances, autoApply_fn).call(this),
        () => __privateMethod$1(this, _FynMeshKernelCore_instances, runtimeFor_fn).call(this, fynApp),
    ...
    async bootstrapFynApp(fynApp) {
      ...
      captureEvent(this.tel, "bootstrap.started", __privateMethod$1(this, _FynMeshKernelCore_instances, appData_fn).call(this, fynApp));
      try {
        ...
        captureEvent(this.tel, "bootstrap.completed", __privateMethod$1(this, _FynMeshKernelCore_instances, appData_fn).call(this, fynApp));
        await __privateMethod$1(this, _FynMeshKernelCore_instances, emitLifecycle_fn).call(this, "FYNAPP_BOOTSTRAPPED", fynApp);
      } catch (error) {
        ...
        __privateMethod$1(this, _FynMeshKernelCore_instances, disposeBus_fn).call(this, fynApp);
        await __privateMethod$1(this, _FynMeshKernelCore_instances, emitLifecycle_fn).call(this, "FYNAPP_BOOTSTRAP_FAILED", fynApp, { error });
    ...
    async shutdownFynApp(name) {
      ...
      try {
        await __privateMethod$1(this, _FynMeshKernelCore_instances, callUnitHook_fn).call(this, fynApp, "shutdown");
        this.removeFromRegistry(fynApp, name);
        __privateMethod$1(this, _FynMeshKernelCore_instances, disposeBus_fn).call(this, fynApp);
        await __privateMethod$1(this, _FynMeshKernelCore_instances, emitLifecycle_fn).call(this, "FYNAPP_SHUTDOWN", fynApp);
        captureEvent(this.tel, "shutdown.completed", __privateMethod$1(this, _FynMeshKernelCore_instances, appData_fn).call(this, fynApp));
    ...
    async suspendFynApp(name) {
      return __privateMethod$1(this, _FynMeshKernelCore_instances, transitionLifecycle_fn).call(this, name, {
        from: "mounted",
        to: "suspended",
        hook: "suspend",
  ...
  callUnitHook_fn = async function(fynApp, hook) {
    for (const exposeName of Object.keys(fynApp.exposes)) {
      ...
      if (typeof fn === "function") {
        await fn.call(fynUnit, __privateMethod$1(this, _FynMeshKernelCore_instances, runtimeFor_fn).call(this, fynApp));
      }
    }
  };
  /**
  ...
  transitionLifecycle_fn = async function(name, opts) {
    ...
    captureEvent(this.tel, `${opts.hook}.started`, __privateMethod$1(this, _FynMeshKernelCore_instances, appData_fn).call(this, fynApp));
    try {
      await __privateMethod$1(this, _FynMeshKernelCore_instances, callUnitHook_fn).call(this, fynApp, opts.hook);
      this.fynAppLifecycle.set(fynApp.name, fynApp.version, opts.to);
      await __privateMethod$1(this, _FynMeshKernelCore_instances, emitLifecycle_fn).call(this, opts.event, fynApp);
      captureEvent(this.tel, `${opts.hook}.completed`, __privateMethod$1(this, _FynMeshKernelCore_instances, appData_fn).call(this, fynApp));
      return true;
    } catch (error) {
  ...
  var _preloadStrategy, _BrowserKernel_instances, resolvePreloadStrategy_fn, _hinted, preloadTarget_fn, injectPreloadLink_fn;
  class BrowserKernel extends FynMeshKernelCore {
    constructor() {
      super(...arguments);
      __privateAdd(this, _BrowserKernel_instances);
      __privateAdd(this, _preloadStrategy, {
        depth: 1,
        // Default: requested + immediate dependencies
        priority: "static",
        priorityByDepth: {
      ...
      __privateAdd(this, _hinted, /* @__PURE__ */ new Set());
    }
    /**
    ...
    tryPreload(url, depth) {
      if (__privateGet(this, _preloadStrategy).disabled) {
        console.debug(`\u23ED\uFE0F  Preload disabled, skipping: ${url} (depth: ${depth})`);
        return;
      }
      if (depth > __privateGet(this, _preloadStrategy).depth) {
        console.debug(`\u23ED\uFE0F  Depth ${depth} > max ${__privateGet(this, _preloadStrategy).depth}, skipping: ${url}`);
        return;
      }
      __privateMethod(this, _BrowserKernel_instances, injectPreloadLink_fn).call(this, url);
    }
    /**
     * Override loadFynAppsByName to handle preload strategy
     */
    async loadFynAppsByName(requests, options) {
      const strategy = __privateMethod(this, _BrowserKernel_instances, resolvePreloadStrategy_fn).call(this, options);
      const previousStrategy = __privateGet(this, _preloadStrategy);
      __privateSet(this, _preloadStrategy, strategy);
      try {
        await super.loadFynAppsByName(requests, options);
      } finally {
        __privateSet(this, _preloadStrategy, previousStrategy);
      }
    }
    /**
    ...
    async loadFynApp(baseUrl, loadId) {
      ...
      try {
        ...
        console.debug("\u{1F680} Loading FynApp from", urlPath);
  ...
  _preloadStrategy = new WeakMap();
  _BrowserKernel_instances = new WeakSet();
  /**
   ...
   */
  resolvePreloadStrategy_fn = function(options) {
    const preload = options?.preload;
    const defaults = __privateGet(this, _preloadStrategy);
    if (!preload) {
      return defaults;
    }
    ...
    return {
      ...defaults,
      ...Object.fromEntries(Object.entries(preload).filter(([, v]) => v !== void 0))
    };
  };
  _hinted = new WeakMap();
  /**
   ...
   */
  preloadTarget_fn = function(url) {
    try {
      return globalThis.Federation?.bundleUrlFor?.(url) || url;
    } catch {
      return url;
    }
  };
   ...
   * @private
   */
  injectPreloadLink_fn = function(url) {
    if (typeof document === "undefined" || !document.head) {
      return;
    }
    const target = __privateMethod(this, _BrowserKernel_instances, preloadTarget_fn).call(this, url);
    if (target !== url) {
      console.debug(`\u{1F4E6} Preloading ${target}, the file carrying ${url}`);
    }
    if (__privateGet(this, _hinted).has(target)) {
      return;
    }
    __privateGet(this, _hinted).add(target);
  ...
  function createBrowserKernel() {
    ...
    kernel.setRegistryResolver(async (name, range) => {
      return {
        name,
        version: "0.0.0",
        // version not critical for demo resolver; keying by name is fine
    ...
    if (error && typeof error === "object") {
      ...
      if (typeof value.message === "string") {
        return {
          ...
          stack: typeof value.stack === "string" ? value.stack : void 0
        };
      }
    }
    return { message: error === void 0 ? "Unknown error" : String(error) };
  }
