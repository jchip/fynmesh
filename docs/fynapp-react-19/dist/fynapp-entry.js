  ...
  return {
    execute: (function () {
      ...
      function init(_shareScope) {
        ...
        _container._S('esm-react', {"singleton":true,"requiredVersion":"^19.0.0"}, [
          // importee: node_modules/esm-react/src/react-esm-19.development.js
          // from: src
        [[_f('./react-esm-19.development-BgERzBs9.js'), "19.1.0"],
        ["src", "^19.1.0"]]]);
        _container._S('esm-react-dom', {"singleton":true,"requiredVersion":"^19.0.0"},
        [
        // esm-react-dom
        [[_f('./react-dom-esm-19-client.development-COkl4j2j.js'), "19.1.0"]]]);
