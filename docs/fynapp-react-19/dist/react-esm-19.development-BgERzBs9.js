...
var System = Federation._mfBind(
  {
    n: 'react-esm-19.development', // chunk name
    f: 'react-esm-19.development-BgERzBs9.js', // chunk fileName
...
System.register([], (function (exports) {
  ...
  return {
    execute: (function () {
      ...
      const React = exports("default", defReact({}));
      ...
      const {
        ...
        useTransition,
        version,
      } = React; exports({ Children: Children, Component: Component, Fragment: Fragment, Profiler: Profiler, PureComponent: PureComponent, StrictMode: StrictMode, Suspense: Suspense, __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE: __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, __COMPILER_RUNTIME: __COMPILER_RUNTIME, act: act, cache: cache, captureOwnerStack: captureOwnerStack, cloneElement: cloneElement, createContext: createContext, createElement: createElement, createRef: createRef, forwardRef: forwardRef, isValidElement: isValidElement, lazy: lazy, memo: memo, startTransition: startTransition, unstable_useCacheRefresh: unstable_useCacheRefresh, use: use, useActionState: useActionState, useCallback: useCallback, useContext: useContext, useDebugValue: useDebugValue, useDeferredValue: useDeferredValue, useEffect: useEffect, useId: useId, useImperativeHandle: useImperativeHandle, useInsertionEffect: useInsertionEffect, useLayoutEffect: useLayoutEffect, useMemo: useMemo, useOptimistic: useOptimistic, useReducer: useReducer, useRef: useRef, useState: useState, useSyncExternalStore: useSyncExternalStore, useTransition: useTransition, version: version });
...
//# sourceMappingURL=react-esm-19.development-BgERzBs9.js.map
