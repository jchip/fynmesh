...
var System = Federation._mfBind(
  {
    n: 'dev', // chunk name
    f: 'dev-DC79LFD2.js', // chunk fileName
...
System.register([], (function (exports) {
  ...
  return {
    execute: (function () {
      ...
      const sharedConfig = exports("sharedConfig", {
        context: undefined,
        registry: undefined,
        effects: undefined,
        done: false,
      ...
      const IS_DEV = true;
      const equalFn = exports("equalFn", (a, b) => a === b);
      const $PROXY = exports("$PROXY", Symbol("solid-proxy"));
      const SUPPORTS_PROXY = typeof Proxy === "function";
      const $TRACK = exports("$TRACK", Symbol("solid-track"));
      const $DEVCOMP = exports("$DEVCOMP", Symbol("solid-dev-component"));
      const signalOptions = {
        equals: equalFn
      };
      let ERROR = null;
...
//# sourceMappingURL=dev-DC79LFD2.js.map
